...
class FeedbackJaxConfig(PretrainedConfig):
    ...
    def from_text_configs(cls, text_config: PretrainedConfig, **kwargs):
        r"""
        Instantiate a :class:`FeedbackJaxConfig` (or a derived class) from text model configuration and
        vision model configuration.

        Returns:
            :class:`FeedbackJaxConfig`: An instance of a configuration object
        """
